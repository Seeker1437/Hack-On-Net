...
namespace HackLinks.Common.Util
{
    ...
    {
        private const string TitlePrefix = "HackLinks Server : ";
        ...
        /// </summary>
        /// <param name="consoleTitle">The title to appear on the console window.</param>
        /// <param name="color">Color of the logo.</param>
        public static void WriteHeader(string consoleTitle = "", ConsoleColor color = ConsoleColor.Gray)
        {
